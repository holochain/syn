...
For more details read the [article](https://blog.holochain.org/decentralized-next-level-collaboration-apps-with-syn/), read the [design documents](DESIGN.md), and check out the example app, SynText, in the [/ui](ui/) directory.
